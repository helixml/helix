...
echo "========================================"
echo "Starting Helix Personal Dev Environment with Wayfire (Wayland)"
echo "========================================"
...
# This ensures Wayfire compositor starts instead
unset RUN_SWAY
...
# Copy Wayfire configuration if it exists
if [ -f "/cfg/wayfire/wayfire.ini" ]; then
    cp /cfg/wayfire/wayfire.ini "$XDG_CONFIG_HOME/wayfire/wayfire.ini"
    echo "✅ Wayfire configuration copied"
fi
...
echo "========================================"
echo "Starting Wayfire compositor via GOW launcher..."
echo "========================================"

# Source GOW functions and start Wayfire via launcher
source /opt/gow/launch-comp.sh

# Start Wayfire directly
# Wayfire will create its own Wayland display
exec launcher wayfire
