...
function launch_desktop() {
    ...
    # Apply keyboard layout override if set dynamically by browser locale detection
    # This override was generated by startup-app.sh from XKB_DEFAULT_LAYOUT env var
