...
require (
	...
	github.com/acorn-io/cmd v0.0.0-20240404013709-34f690bde37b // indirect
	...
	github.com/gptscript-ai/chat-completion-client v0.0.0-20240404013040-49eb8f6affa1 // indirect
