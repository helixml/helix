...
func (mr *MockFileStoreMockRecorder) CopyFile(ctx, from, to interface{}) *gomock.Call {
...
func (mr *MockFileStoreMockRecorder) CreateFolder(ctx, path interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFileStoreMockRecorder) Delete(ctx, path interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFileStoreMockRecorder) DownloadFolder(ctx, path interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFileStoreMockRecorder) Get(ctx, path interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFileStoreMockRecorder) List(ctx, path interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFileStoreMockRecorder) OpenFile(ctx, path interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFileStoreMockRecorder) Rename(ctx, path, newPath interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFileStoreMockRecorder) SignedURL(ctx, path interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFileStoreMockRecorder) UploadFolder(ctx, path, r interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFileStoreMockRecorder) WriteFile(ctx, path, r interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
