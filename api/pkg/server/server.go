...
func (apiServer *HelixAPIServer) registerRoutes(_ context.Context) (*mux.Router, error) {
	...
	authRouter.HandleFunc("/knowledge/{id}/versions", system.Wrapper(apiServer.listKnowledgeVersions)).Methods("GET")
	...
	runnerRouter.HandleFunc("/runner/{runnerid}/slots", system.DefaultWrapper(apiServer.setRunnerSlots)).Methods("PATCH")
