...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/personal-dev-environments/{id}/stream-token": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/types.StreamingTokenResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/api/v1/sessions/{id}/stream-token": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/sessions/{id}/streaming-access": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/types.StreamingAccessGrant"
                            }
                        }
                    },
                    "401": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Access grant details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/sessions/{id}/streaming-access/{grant_id}": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "types.SpecTask": {
            ...
            "properties": {
                ...
                "implementation_agent": {
                    "description": "Zed agent for coding",
                    "type": "string"
                },
                "implementation_plan": {
                ...
                "implementation_session_id": {
                    "description": "Zed session for implementation",
                    "type": "string"
                },
                "labels": {
                    "type": "array",
                ...
                "spec_agent": {
                    "description": "Spec-driven agent assignment",
                    "type": "string"
                },
                "spec_approved_at": {
                    "type": "string"
                ...
                "spec_session_id": {
                    "description": "Helix session for spec phase",
                    "type": "string"
                },
                "started_at": {
                    "type": "string"
                ...
                "work_sessions": {
                    "description": "Relationships (loaded via joins, not stored)",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/types.SpecTaskWorkSession"
                    }
