...
type orgMemberNotifier struct{ store store.Store }
...
func (h orgMemberNotifier) NotifyInfo(ctx context.Context, orgID, userID, fromBot, title, message string) error {
	if userID == "" {
