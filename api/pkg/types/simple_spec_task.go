...
type SpecTask struct {
	...
	ShortTitle      string           `json:"short_title,omitempty" gorm:"size:100"`      // Auto-generated by agent
	UserShortTitle  string           `json:"user_short_title,omitempty" gorm:"size:100"` // User override
	...
	StatusUpdatedAt *time.Time       `json:"status_updated_at,omitempty" gorm:"index"`   // When status last changed (for Kanban column sorting)
