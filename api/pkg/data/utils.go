...
// func CreateToolSession(req types.CreateSessionRequest, resp *tools.RunActionResponse) (types.Session, error) {
// func CreateToolSession(req types.CreateSessionRequest, actionable *tools.IsActionableResponse) (*types.Session, *types.Interaction) {
// 	systemInteraction := &types.Interaction{
// 		ID:       system.GenerateUUID(),
// 		Created:  time.Now(),
// 		Updated:  time.Now(),
// 		Creator:  types.CreatorTypeSystem,
// 		Mode:     types.SessionModeAction,
// 		Message:  "",
// 		Files:    []string{},
// 		State:    types.InteractionStateWaiting,
// 		Finished: false,
// 		Metadata: map[string]string{
// 			"raw_message": actionable.Justification,
// 			"api":         actionable.Api,
// 		},
// 		DataPrepChunks: map[string][]types.DataPrepChunk{},
// 	}
...
// 	interactions := append(
// 		req.UserInteractions, // User interaction
// 		systemInteraction,    // Waiting interaction
// 	)
...
// 	return session, systemInteraction
// }
