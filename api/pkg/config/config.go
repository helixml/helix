...
type Helix struct {
	...
	ModelTTL           time.Duration `envconfig:"HELIX_MODEL_TTL" default:"60s"`                          // How long to keep models warm before allowing other work to be scheduled
	...
	RunnerTTL          time.Duration `envconfig:"HELIX_RUNNER_TTL" default:"300s"`                        // How long before runners are considered dead
