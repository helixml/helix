...
type Runtimes struct {
	...
	Ollama struct {
		...
		WarmupModels []string `envconfig:"RUNTIME_OLLAMA_WARMUP_MODELS" default:"mistral:7b-instruct,mixtral:instruct,deepseek-coder:33b,adrienbrault/nous-hermes2pro:Q5_K_S,qwen:72b-chat"`
