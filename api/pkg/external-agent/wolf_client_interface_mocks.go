...
// Source: pkg/external-agent/wolf_client_interface.go
//
// Generated by this command:
//
//	mockgen -source pkg/external-agent/wolf_client_interface.go -destination pkg/external-agent/wolf_client_interface_mocks.go -package external_agent
//
