...
func New(id, orgID, name string, kind transport.Kind, config json.RawMessage, createdBy string, createdAt time.Time) (Trigger, error) {
	...
	return Trigger{Aggregate: a, Name: name, Kind: kind, Config: config}, nil
}
