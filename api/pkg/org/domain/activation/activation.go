...
func New(id ID, workerID orgchart.NodeID, triggers []Trigger, startedAt time.Time, orgID string) (*Activation, error) {
	if id == "" {
...
type Repository interface {
	...
	ListForWorker(ctx context.Context, orgID string, workerID orgchart.NodeID, limit int) ([]*Activation, error)
}
