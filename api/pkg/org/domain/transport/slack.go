...
// KindSlack binds a Topic to one of its org's installed Slack
// workspaces. The three tenancy layers live apart (see
// design/2026-06-23-helix-org-slack-serviceconnection.md):
//
