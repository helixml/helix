...
type grantView struct {
	ID       orgchart.GrantID  `json:"id"`
	WorkerID orgchart.WorkerID `json:"workerId"`
	ToolName tool.Name         `json:"toolName"`
}

func grantViewOf(g orgchart.ToolGrant) grantView {
...
func (t *GetGrant) Invoke(ctx context.Context, inv tool.Invocation) (json.RawMessage, error) {
	...
	g, err := t.deps.Store.Grants.Get(ctx, orgID, orgchart.GrantID(args.ID))
	if err != nil {
