...
type positionView struct {
	ID       orgchart.PositionID  `json:"id"`
	RoleID   orgchart.RoleID      `json:"roleId"`
	ParentID *orgchart.PositionID `json:"parentId"`
}

func positionViewOf(p orgchart.Position) positionView {
...
func (t *ListPositions) Invoke(ctx context.Context, inv tool.Invocation) (json.RawMessage, error) {
...
func (t *GetPosition) Invoke(ctx context.Context, inv tool.Invocation) (json.RawMessage, error) {
	...
	pos, err := t.deps.Store.Positions.Get(ctx, orgID, orgchart.PositionID(args.ID))
	if err != nil {
...
func (t *ListPositionChildren) Invoke(ctx context.Context, inv tool.Invocation) (json.RawMessage, error) {
	...
	positions, err := t.deps.Store.Positions.ListChildren(ctx, orgID, orgchart.PositionID(args.ParentID))
	if err != nil {
