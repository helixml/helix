...
// PostResOffer is a paid mutator transaction binding the contract method 0xae625e56.
//
// Solidity: function postResOffer(uint256 instructionPrice, uint256 instructionCap, uint256 memoryCap, uint256 localStorageCap, uint256 bandwidthCap, uint256 bandwidthPrice, uint256 matchIncentive, uint256 verificationCount, uint256 misc) payable returns()
func (_Modicum *ModicumTransactor) PostResOffer(opts *bind.TransactOpts, instructionPrice *big.Int, instructionCap *big.Int, memoryCap *big.Int, localStorageCap *big.Int, bandwidthCap *big.Int, bandwidthPrice *big.Int, matchIncentive *big.Int, verificationCount *big.Int, misc *big.Int) (*types.Transaction, error) {
...
//
// Solidity: function postResOffer(uint256 instructionPrice, uint256 instructionCap, uint256 memoryCap, uint256 localStorageCap, uint256 bandwidthCap, uint256 bandwidthPrice, uint256 matchIncentive, uint256 verificationCount, uint256 misc) payable returns()
func (_Modicum *ModicumSession) PostResOffer(instructionPrice *big.Int, instructionCap *big.Int, memoryCap *big.Int, localStorageCap *big.Int, bandwidthCap *big.Int, bandwidthPrice *big.Int, matchIncentive *big.Int, verificationCount *big.Int, misc *big.Int) (*types.Transaction, error) {
...
//
// Solidity: function postResOffer(uint256 instructionPrice, uint256 instructionCap, uint256 memoryCap, uint256 localStorageCap, uint256 bandwidthCap, uint256 bandwidthPrice, uint256 matchIncentive, uint256 verificationCount, uint256 misc) payable returns()
func (_Modicum *ModicumTransactorSession) PostResOffer(instructionPrice *big.Int, instructionCap *big.Int, memoryCap *big.Int, localStorageCap *big.Int, bandwidthCap *big.Int, bandwidthPrice *big.Int, matchIncentive *big.Int, verificationCount *big.Int, misc *big.Int) (*types.Transaction, error) {
	return _Modicum.Contract.PostResOffer(&_Modicum.TransactOpts, instructionPrice, instructionCap, memoryCap, localStorageCap, bandwidthCap, bandwidthPrice, matchIncentive, verificationCount, misc)
}
