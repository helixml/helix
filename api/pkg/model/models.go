...
func GetDefaultOllamaModels() (map[string]Model, error) {
	...
	models[Model_Ollama_Mixtral] = &OllamaGenericText{
		id:            "mixtral:instruct", // https://ollama.com/library/mixtral
		name:          "Mixtral",
		memory:        GB * 24,
		contextLength: 32768,
	}

	// OLDER MODELS, keeping just for backward compatibility (if anyone
	// specifies them manually in their runner configuration)
	models[Model_Ollama_Mistral7b] = &OllamaGenericText{
		id:            "mistral:7b-instruct", // https://ollama.com/library/mistral
		name:          "Mistral 7B v0.3",
		memory:        MB * 6440,
		contextLength: 32768,
	}
	models[Model_Ollama_Mistral7b_v3] = &OllamaGenericText{
		id:            "mistral:v0.3", // https://ollama.com/library/mistral
		name:          "Mistral 7B v0.3",
		memory:        MB * 6440,
		contextLength: 32768,
	}
	models[Model_Ollama_CodeLlama] = &OllamaGenericText{
		id:            "codellama:70b-instruct-q2_K", // https://ollama.com/library/codellama
		name:          "CodeLlama 70B",
		memory:        GB * 24,
		contextLength: 16384,
	}
	...
	models[Model_Ollama_Llama3_70b] = &OllamaGenericText{
		id:            "llama3:70b", // https://ollama.com/library/llama3
		name:          "Llama 3 70B",
		memory:        GB * 39,
		contextLength: 4096,
		description:   "Large model with enhanced capabilities",
	...
	models[Model_Ollama_Llama3_8b_fp16] = &OllamaGenericText{
		id:            "llama3:8b-instruct-fp16", // https://ollama.com/library/llama3
	...
	models[Model_Ollama_Llama3_8b_q6_K] = &OllamaGenericText{
		id:            "llama3:8b-instruct-q6_K", // https://ollama.com/library/llama3
	...
	models[Model_Ollama_Llama3_8b_q8_0] = &OllamaGenericText{
		id:            "llama3:8b-instruct-q8_0", // https://ollama.com/library/llama3
