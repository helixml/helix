...
//
//	mockgen -source manager.go -destination manager_mocks.go -package openai
//
...
func (m *MockProviderManager) GetClient(ctx context.Context, req *GetClientRequest) (Client, error) {
	m.ctrl.T.Helper()
