...
- [ ] `git fetch upstream`
- [ ] Note divergence count: `git rev-list --count main..upstream/main` (upstream commits) and `git rev-list --count upstream/main..main` (fork commits)
- [ ] Create feature branch: `git checkout -b feature/001909-merge-latest-zed`
