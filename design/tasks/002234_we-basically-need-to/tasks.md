...
- [ ] Proofread the whole README against the Tone Guideline (concrete/technical, no unsubstantiated superlatives, developer-oriented) while keeping the helix-next message; confirm final length stays scannable (≈ current length or shorter).
