...
- [ ] Draft new H1 title and tagline reflecting agentic engineering / agent control room (replace "AI Agents on a Private GenAI Stack").
...
- [ ] Verify all links resolve (docs, Discord, launchpad, `./CONTRIBUTING.md`, `./local-development.md`, `api/pkg/agent/SPEC.md`) and images render in GitHub Markdown preview.
- [ ] Proofread for tone/claim consistency with `helix-next` and confirm final length stays scannable (≈ current length or shorter).
