...
- New unit tests in `api/pkg/orgstore/authz_test.go`: org-scoped credential denied on another organization (member and owner paths), allowed in its own org with the correct membership role, and unscoped users unaffected.
