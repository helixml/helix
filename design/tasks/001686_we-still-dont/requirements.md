...
1. Within ~200ms of clicking "Start Planning" (i.e., as soon as the API call succeeds), the desktop viewer area shows the "Starting Desktop..." `CircularProgress` spinner.
