...
- [ ] Add "Start immediately" checkbox UI below the "Skip planning" (formerly "Just Do It") checkbox in `NewSpecTaskForm.tsx`
- [ ] Build verification: `go build ./api/pkg/...` and `cd frontend && yarn build`
- [ ] Write PR description files
