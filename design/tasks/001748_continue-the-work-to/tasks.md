...
- [x] Rebuild desktop-bridge and re-test recording with motion
- [x] Verified: 14.8s recording with GNOME overview toggle, Nautilus, Calculator — clear motion between frames

## Phase 5: Push & PR

- [x] Push feature branch to origin
- [x] Create final PR description
