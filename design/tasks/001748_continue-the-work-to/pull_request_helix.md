# Fix agent screencast recording: merge main, code quality, and MP4 timing

## Summary
Continues work from task 001386 to make the agent screencast recording feature mergeable. Merges main, fixes code quality issues found in review, and fixes a critical bug where MP4 files had incorrect duration (~0.04s instead of actual recording length).
...
- `stop_recording` → produces valid MP4 (verified with ffprobe: 5.53s, 59.68fps, 1920x1080)
