...
- [x] Test: Change resolution on Settings tab → switch to Appearance → change name → switch back to Settings → verify resolution is preserved
- [x] Test: Change name on Appearance → switch to Settings → change model → switch back to Appearance → verify name is preserved
