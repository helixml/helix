...
- [x] Verify in the browser: trigger a new notification and confirm both the bell badge and the panel header count pill stay red persistently (not just a brief flash); open the drawer and confirm both revert to gray
