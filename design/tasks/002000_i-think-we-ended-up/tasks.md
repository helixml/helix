...
- [x] Commit code changes on `feature/002000-move-acp-agent-logs` and push to origin (no PR creation — the platform handles that). Commit: `fix(desktop): move ACP Agent Logs terminal to last workspace, not minimize`
