...
- [x] Test end-to-end: create a user endpoint, edit it as admin switching to global, confirm it appears in the provider list for another user and is included in the system refresh query
