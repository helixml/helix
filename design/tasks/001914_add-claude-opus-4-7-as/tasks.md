...
- [~] Edit `frontend/src/constants/models.ts`: add `"claude-opus-4-7"` as the first entry in the `// Anthropic` block of `RECOMMENDED_CODING_MODELS`, above `"claude-opus-4-6"`.
