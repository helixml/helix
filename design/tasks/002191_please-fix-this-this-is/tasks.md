...
- [x] QA in the local Helix instance: list org apps with helix-org enabled and confirm a 200 response with no `42P01` error in the API logs. **Verified** — see design.md "QA Results".
