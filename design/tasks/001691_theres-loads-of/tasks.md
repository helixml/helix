...
- [~] Verify: start editing a queued prompt, wait 2+ seconds, confirm the prompt is not sent; save edit and confirm new content is queued; cancel and confirm original content is queued
