...
- [ ] Update both composer mount sites in `SpecTaskDetailContent.tsx` (desktop ~line 2015 and mobile ~line 2819) to call `sessionViewRef.current?.repinToBottom()` from `onHeightChange` instead of `scrollToBottom()`.
