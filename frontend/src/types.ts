...
export type IModelName = 'mistralai/Mistral-7B-Instruct-v0.1' | 'stabilityai/stable-diffusion-xl-base-1.0' | 'mistral:7b-instruct' | 'mixtral:instruct' | 'llama3:instruct' | 'llama3:70b' | 'phi3:instruct' | 'gemma2:9b' | 'gemma2:27b'
...
export const MODEL_NAME_OLLAMA_GEMMA2_9B: IModelName = 'gemma2:9b'
export const MODEL_NAME_OLLAMA_GEMMA2_27B: IModelName = 'gemma2:27b'
