...
// Microsoft Logo SVG
export const MicrosoftLogo = (props: any) => (
...
// Slack Logo SVG
export const SlackLogo = (props: any) => (
...
export interface PartialOAuthProvider {
  type: string;
  name?: string;
  description?: string;
}

export const BUILT_IN_PROVIDERS: PartialOAuthProvider[] = [
  {
    type: 'github',
    name: 'GitHub',
