...
const DiffFileList: FC<DiffFileListProps> = ({
  files,
  selectedFile,
  onSelectFile,
}) => {
    ...
    if (status === "added") {
      return (
        <Plus
          ...
          style={{ color: themeConfig.greenRoot }}
        />
      );
    }
    if (status === "deleted") {
      return (
        <Minus
          size={iconSize}
          strokeWidth={strokeWidth}
          style={{ color: themeConfig.redRoot }}
        />
      );
    }
    if (status === "renamed") {
      return (
        <ArrowRightLeft
          size={iconSize}
          strokeWidth={strokeWidth}
          style={{ color: themeConfig.tealRoot }}
        />
      );
    }
    if (status === "copied") {
    ...
    if (imageExts.includes(ext || "")) {
      return (
        <Image
          size={iconSize}
          strokeWidth={strokeWidth}
          style={{ color: themeConfig.yellowRoot }}
        />
      );
    }
    ...
    if (docExts.includes(ext || "")) {
      return (
        <FileText
          size={iconSize}
          strokeWidth={strokeWidth}
          style={{ color: themeConfig.magentaRoot }}
        />
      );
    }
