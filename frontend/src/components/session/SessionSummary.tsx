...
export const SessionSummary: FC<{
  ...
  // Get basic info
  const modelHeadline = getHeadline(session.model_name, session.mode, session.lora_dir)
    ...
    >
      ...
      <Box 
        sx={{ 
          ...
          bottom: 0,
          width: '3px',
          background: 'linear-gradient(180deg, rgba(128, 90, 213, 0.9) 0%, rgba(128, 90, 213, 0.4) 100%)',
        ...
        <Grid container spacing={1} alignItems="center">
          ...
          <Grid item>
            <Box sx={{ 
              ...
              <AccessTimeIcon sx={{ fontSize: 14, color: 'rgba(255, 255, 255, 0.6)', mr: 0.5 }} />
              <Typography 
                variant="caption" 
                sx={{ 
