...
`;
    ...
    expect(result).toMatch(
      /__THINKING_WIDGET__This is still thinking__THINKING_WIDGET__/,
    );
  });
...
<excerpts>
  ...
  <excerpt>
    ...
    const doc1Excerpt = citationData?.excerpts.find(
      (e) => e.docId === "doc-id-1",
    );
    const doc2Excerpt = citationData?.excerpts.find(
      (e) => e.docId === "doc-id-2",
    );
...
again reference the second doc [DOC_ID:doc-id-2].`;
    ...
    expect(result).toContain(
      'first doc <a target="_blank" href="https://example.com/first.txt" class="doc-citation">[1]</a>',
    );
    expect(result).toContain(
      'second doc <a target="_blank" href="https://example.com/second.txt" class="doc-citation">[2]</a>',
    );

    // Second occurrence checks - should use the same numbers
    expect(result).toContain(
      'first doc again <a target="_blank" href="https://example.com/first.txt" class="doc-citation">[1]</a>',
    );
    expect(result).toContain(
      'second doc <a target="_blank" href="https://example.com/second.txt" class="doc-citation">[2]</a>',
    );
...
<excerpts>
  <excerpt>
    ...
    expect(excerpt?.snippet).toBe(
      "Content with special characters: &lt;div&gt; and &amp; and &quot;quotes&quot;",
    );
        ...
        session_rag_results: [
          {
            ...
            document_group_id: "group-123",
            content:
              "This document discusses neural networks and their importance in modern AI systems.",
          ...
          },
          {
            ...
            document_group_id: "group-123",
            content:
              "Natural language processing has become a major focus of research in recent years.",
  ...
  <excerpt>
    ...
    expect(["fuzzy", "failed"]).toContain(
      citationData?.excerpts[0].validationStatus,
    );

    // If it's a fuzzy match, make sure the similarity threshold is reasonable
    if (citationData?.excerpts[0].validationStatus === "fuzzy") {
      expect(citationData?.excerpts[0].validationMessage).toContain(
        "partially verified",
      );
    } else {
      expect(citationData?.excerpts[0].validationMessage).toContain(
      ...
      session_rag_results: [
        {
          ...
          document_group_id: "group-123",
          content:
            "This is the exact content from a source document that will be quoted exactly.",
        ...
        },
        {
          ...
          document_group_id: "group-123",
          content:
            "This text contains information about neural networks and machine learning algorithms.",
        ...
        session_rag_results: [
          {
            ...
            document_group_id: "group-123",
            content:
              "This is chunk 1 of the document. It contains some specific information about machine learning.",
          ...
          },
          {
            ...
            document_group_id: "group-123",
            content:
              "This is chunk 2 of the document. It discusses neural networks and their applications.",
            source: "chunked-document.pdf",
          ...
          },
          {
            ...
            document_group_id: "group-123",
            content:
              "This is chunk 3 of the document. It explores transformers and attention mechanisms.",
            source: "chunked-document.pdf",
        ...
        session_rag_results: [
          {
            ...
            document_group_id: "group-123",
            content:
              "This is the first part of a document that continues across two chunks.",
          ...
          },
          {
            ...
            document_group_id: "group-123",
            content:
              "This continues from the previous chunk and finishes the document.",
            source: "spanning-document.pdf",
            metadata: { offset: "1024" },
          },
        ],
...
export const MessageProcessorTests = {
  description:
    "Tests for the MessageProcessor class to validate thinking tag behavior.",
};
