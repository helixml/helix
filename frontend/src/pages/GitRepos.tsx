...
const GitRepos: FC = () => {
  ...
  const [externalRepoType, setExternalRepoType] =
    useState<TypesExternalRepositoryType>(
  ...
  const handleSampleTypeChange = (sampleTypeId: string) => {
    ...
    if (sampleTypeId) {
      const selectedType = sampleTypes.find(
        (t: ServerSampleType) => t.id === sampleTypeId,
      );
  ...
  const handleBrowseSelectRepository = async (
    ...
    try {
      ...
      const githubSettings =
        actualProviderType === "github" && providerCreds
          ? {
      ...
      const gitlabSettings =
        actualProviderType === "gitlab" && providerCreds
          ? {
              personal_access_token: providerCreds.pat,
      ...
      const azureDevOpsSettings =
        actualProviderType === "azure-devops" && providerCreds
          ? {
      ...
      const bitbucketSettings =
        actualProviderType === "bitbucket" && providerCreds
          ? {
      ...
      await apiClient.v1GitRepositoriesCreate({
        ...
        external_type:
          externalTypeMap[actualProviderType] ||
          ("github" as TypesExternalRepositoryType),
        kodit_indexing: true,
  ...
  if (!account.user) {
    return (
      <Page breadcrumbTitle="Git Repositories" orgBreadcrumbs={true}>
        <Container maxWidth="xl" sx={{ mb: 4 }}>
          <Card sx={{ textAlign: "center", py: 8 }}>
            <CardContent>
              <GitBranch
                size={64}
                style={{ color: "gray", marginBottom: 24 }}
              />
  ...
  return (
    <Page breadcrumbTitle="" orgBreadcrumbs={false}>
      <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
            ...
            <Box>
              ...
              >
                ...
                >
                  ...
                  <span style={{ color: "text.secondary", fontWeight: 300 }}>
                    /
                  </span>
                  ...
                  <Box sx={{ flex: 1 }}>
                    ...
                    >
                      ...
                      >
                        {ownerSlug}
                        <span
                          style={{ color: "text.secondary", fontWeight: 400 }}
                        >
                          /
                        </span>
                        {repo.name || repo.id}
          ...
          <Card sx={{ textAlign: "center", py: 8 }}>
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                Connect your existing repositories or create new ones to start
        ...
        <Dialog
          open={demoRepoDialogOpen}
          onClose={() => setDemoRepoDialogOpen(false)}
          maxWidth="sm"
          fullWidth
        >
          ...
          <DialogContent>
            <Stack spacing={2} sx={{ mt: 1 }}>
              <Typography variant="body2" color="text.secondary">
                Choose a demo repository template to get started quickly with
                ...
                <>
                  ...
                  <Alert severity="info">
                    {demoKoditIndexing
                      ...
                      : sampleTypes.find(
                          (t: ServerSampleType) => t.id === selectedSampleType,
                        )?.description}
                  </Alert>
                </>
              )}
