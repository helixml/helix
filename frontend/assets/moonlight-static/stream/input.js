import { StreamControllerCapabilities, StreamMouseButton } from "../api_bindings.js";
import { ByteBuffer, I16_MAX, U16_MAX, U8_MAX } from "./buffer.js";
import { extractGamepadState, SUPPORTED_BUTTONS } from "./gamepad.js";
...
export class StreamInput {
    ...
    setPeer(peer) {
        var _a, _b, _c, _d;
        if (this.peer) {
            (_a = this.keyboard) === null || _a === void 0 ? void 0 : _a.close();
            (_b = this.mouse) === null || _b === void 0 ? void 0 : _b.close();
            (_c = this.touch) === null || _c === void 0 ? void 0 : _c.close();
            (_d = this.controllers) === null || _d === void 0 ? void 0 : _d.close();
    ...
    sendMousePosition(x, y, referenceWidth, referenceHeight) {
        this.buffer.reset();
        this.buffer.putU8(1);
    ...
    sendMousePositionClientCoordinates(clientX, clientY, rect, mouseButton) {
    ...
    tryOpenControllerChannel(id) {
        var _a, _b;
        if (!this.controllerInputs[id]) {
            this.controllerInputs[id] = (_b = (_a = this.peer) === null || _a === void 0 ? void 0 : _a.createDataChannel(`controller${id}`, {
                maxRetransmits: 0,
                ordered: true,
